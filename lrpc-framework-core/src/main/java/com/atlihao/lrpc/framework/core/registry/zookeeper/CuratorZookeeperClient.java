 ...
 * @Description:
 * @Author: lihao726726
 * @CreateDate: 2023/8/9 5:58 下午
 * @UpdateUser: lihao726726
 * @UpdateDate: 2023/8/9 5:58 下午
 * @Version: 1.0.0
 */
@Getter
public class CuratorZookeeperClient extends AbstractZookeeperClient {
    ...
    public static void main(String[] args) {
        ...
        abstractZookeeperClient.watchNodeData("/lrpc/com.atlihao.lrpc.framework.interfaces.DataService/provider/10.1.21.11:9092",
                new Watcher() {
                    @Override
